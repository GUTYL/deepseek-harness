...
describe('ui-theme apply', () => {
  ...
  it('loads Host settings at boot, refreshes its namespace, and reads them on a non-loopback page', async () => {
    const b = await bench()
    ...
    // A non-loopback page reads and writes Host settings like any admitted page.
